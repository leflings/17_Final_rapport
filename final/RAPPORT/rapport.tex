...
\section*{Installationsvejledning} % (fold)
...
Tilhørende tekst: Et uddrag fra klasse diagrammet over vores simulator, der fulde kan ses i bilaget.
...
\section{Forbedringer} % (fold)

De her forbedringer kan man laver

% section Forbedringer (end)
